...
def rule_cve202520199(configuration, commands, device, devices):
    ...
    # The vulnerability affects all devices running vulnerable versions
    # regardless of configuration, as it's a CLI input validation issue
    # that can be exploited by any user with privilege level 15
    assert False, (
