...
def rule_cve202520201(configuration, commands, device, devices):
    ...
    This check verifies if the device is running a vulnerable version.
    """
    ...
    # If version is vulnerable, device is at risk
    if version_vulnerable:
        assert False, (
            ...
            "on the underlying operating system through insufficient input validation when processing "
