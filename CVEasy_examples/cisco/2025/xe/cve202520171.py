...
def rule_cve202520171(configuration, commands, device, devices):
    """
    This rule checks for CVE-2025-20171 vulnerability in Cisco IOS XE Software.
    ...
    # Check if SNMP v3 is enabled (both group and user must be configured)
    ...
    if snmp_v1_v2c_enabled or snmp_v3_enabled:
        assert False, (
            ...
            "AND has SNMP enabled (v1, v2c, or v3). An authenticated attacker with "
            "valid SNMP credentials could send a crafted SNMP request to cause the "
