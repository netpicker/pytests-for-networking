...
def rule_cve202520176(configuration, commands, device, devices):
    """
    This rule checks for CVE-2025-20176 vulnerability in Cisco IOS XE Software.
    ...
    # Versions that need fixes: 3.11E, 16.12, 17.9, 17.12, 17.15
    vulnerable_versions = [
        # 3.11E versions (before 3.11.12E)
        '3.11.0E', '3.11.1E', '3.11.2E', '3.11.3E', '3.11.4E', '3.11.5E', 
        '3.11.6E', '3.11.7E', '3.11.8E', '3.11.9E', '3.11.10E', '3.11.11E',
        # 16.12 versions (before 16.12.13)
    ...
    if snmp_community_enabled or snmp_v3_enabled:
        assert False, (
            ...
            "An authenticated, remote attacker could send a crafted SNMP request to cause a DoS condition. "
