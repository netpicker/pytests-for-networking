...
def rule_cve202520172(configuration, commands, device, devices):
    """
    This rule checks for CVE-2025-20172 vulnerability in Cisco IOS XE Software.
    
    A vulnerability in the SNMP subsystem could allow an authenticated, remote 
    attacker to cause a DoS condition on an affected device. The vulnerability 
    ...
    vulnerable_versions = [
        ...
        '17.9.1', '17.9.2', '17.9.1a', '17.9.3', '17.9.2a', '17.9.3a', '17.9.4', 
        '17.9.4a', '17.9.5', '17.9.6',
    ...
    if snmp_v1_v2c_enabled or snmp_v3_enabled:
        assert False, (
            ...
            "The device is running a vulnerable version of Cisco IOS XE Software "
            "with SNMP enabled. An authenticated, remote attacker could exploit "
            "this vulnerability by sending a crafted SNMP request to cause the "
